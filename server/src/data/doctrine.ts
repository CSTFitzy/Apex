...
export const doctrineProfiles: DoctrineProfile[] = [
  {
    ...
    composition:
      'Motorized rifle battalion built around IFV/APC platoons with organic mortars and ATGM sections.',
...
export function matchDoctrineProfiles(text: string): DoctrineProfile[] {
  const lower = text.toLowerCase();
  return doctrineProfiles.filter((profile) =>
